...
M['newText'] = function(params, isLevel)
    ...
    GAME.lua = GAME.lua .. '\n display.newText(GAME.group, tostring(' .. text .. '), ' .. posX .. ', ' .. posY .. ', font, ' .. size .. ')'
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[name]:setFillColor(colors[1]/255, colors[2]/255, colors[3]/255) end)'
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[name].alpha = ' ..  alpha .. ' / 100 end)'
    ...
    if isLevel then
        GAME.lua = GAME.lua .. '\n pcall(function() local obj = GAME_texts[object.name]'
        GAME.lua = GAME.lua .. '\n obj.rotation = object.rotation end)'
    end
end
...
M['newText2'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name, colors, font = ' .. name .. ', ' .. colors .. ', other.getFont(' .. font .. ')'
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[name]:removeSelf() end)'
    GAME.lua = GAME.lua .. '\n GAME_texts[name] = display.newText({parent = GAME.group, text = tostring(' .. text .. '),'
    GAME.lua = GAME.lua .. '\n x = ' .. posX .. ', y = ' .. posY .. ', width = ' .. width .. ', height = ' .. height .. ','
    GAME.lua = GAME.lua .. '\n align = ' .. align .. ', font = font, fontSize = ' .. size .. '}) GAME.group:insert(GAME_texts[name])'
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[name]:setFillColor(colors[1]/255, colors[2]/255, colors[3]/255) end)'
    GAME.lua = GAME.lua .. '\n GAME_texts[name]._density = 1 GAME_texts[name]._bounce = 0'
    GAME.lua = GAME.lua .. '\n GAME_texts[name]._friction = 0 GAME_texts[name]._gravity = 1'
    GAME.lua = GAME.lua .. '\n GAME_texts[name]._body = \'\' GAME_texts[name]._hitbox = {}'
    GAME.lua = GAME.lua .. '\n GAME_texts[name]._touch = \'\' GAME_texts[name]._tag = \'TAG\''
    GAME.lua = GAME.lua .. '\n GAME_texts[name].name = name end)'
end
...
M['updVar'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() ' .. var .. ' = ' .. var .. ' + ' .. value .. ' end)'
end

M['setObjVar'] = function(params)
    local key = CALC(params[1], '\'KEY\'', true)
    local obj, value = 'GAME_objects[' .. CALC(params[2]) .. ']._data', CALC(params[3])
...
M['addTable'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() if ' .. table .. ' then ' .. table .. key .. ' = ' .. value
    GAME.lua = GAME.lua .. '\n else ' .. table .. ' = {} ' .. table .. key .. ' = ' .. value .. ' end end)'
end
...
M['insertTable'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() if ' .. table .. ' then table.insert(' .. table .. ', ' .. key .. ', ' .. value .. ')'
    GAME.lua = GAME.lua .. '\n else ' .. table .. ' = {} table.insert(' .. table .. ', ' .. key .. ', ' .. value .. ') end end)'
end
...
M['removeTable'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() table.remove(' .. table .. ', ' .. key .. ') end)'
end
...
M['resetTable'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() ' .. table .. ' = JSON.decode(' .. value .. ') end)'
end
...
M['saveValue'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local data = GET_GAME_SAVE(CURRENT_LINK)'
    GAME.lua = GAME.lua .. '\n data[tostring(' .. key .. ')] = ' .. value .. ' SET_GAME_SAVE(CURRENT_LINK, data) end)'
end

M['setRandomSeed'] = function(params)
    local seed = CALC(params[1])

    GAME.lua = GAME.lua .. '\n pcall(function() local seed = ' .. seed .. ' SEED = math.sum(UTF8.byte(tostring(seed), 1,'
    GAME.lua = GAME.lua .. '\n UTF8.len(tostring(seed)))) math.randomseed(SEED) end)'
end
...
M['setText'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. name .. '].text = tostring(' .. text .. ') end)'
end
...
M['setTextSize'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. name .. '].size = ' .. size .. ' end)'
end

M['setTextPos'] = function(params)
    local name = CALC(params[1])
    local posX = '(SET_X(' .. CALC(params[2]) .. ', GAME_texts[name]))'
    local posY = '(SET_Y(' .. CALC(params[3]) .. ', GAME_texts[name]))'

    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].x = ' .. posX
    GAME.lua = GAME.lua .. '\n GAME_texts[name].y = ' .. posY .. ' end)'
end
...
M['setTextPosX'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].x = ' .. posX .. ' end)'
end

M['setTextPosY'] = function(params)
    local name = CALC(params[1])
    local posY = '(SET_Y(' .. CALC(params[2]) .. ', GAME_texts[name]))'

    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].y = ' .. posY .. ' end)'
end
...
M['setTextRotation'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. name .. '].rotation = ' .. rotation .. ' end)'
end
...
M['setTextAnchor'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].anchorX = ' .. anchorX
    GAME.lua = GAME.lua .. '\n GAME_texts[name].anchorY = ' .. anchorY .. ' end)'
end
...
M['setTextAlpha'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. name .. '].alpha = ' .. alpha .. ' end)'
end
...
M['setTextColor'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n GAME_texts[' .. name .. ']:setFillColor(colors[1]/255, colors[2]/255, colors[3]/255) end)'
end
...
M['setTextRGB'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n GAME_texts[' .. name .. ']:setFillColor(r, g, b) end)'
end
...
M['setTextHEX'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n GAME_texts[' .. name .. ']:setFillColor(r/255, g/255, b/255) end)'
end
...
M['updTextPosX'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].x'
    GAME.lua = GAME.lua .. '\n = GAME_texts[name].x + ' .. posX .. ' end)'
end
...
M['updTextPosY'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].y'
    GAME.lua = GAME.lua .. '\n = GAME_texts[name].y - ' .. posY .. ' end)'
end
...
M['updTextRotation'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].rotation'
    GAME.lua = GAME.lua .. '\n = GAME_texts[name].rotation + ' .. rotation .. ' end)'
end
...
M['updTextAlpha'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. name .. ' GAME_texts[name].alpha'
    GAME.lua = GAME.lua .. '\n = GAME_texts[name].alpha + ' .. alpha .. ' end)'
end

M['hideText'] = function(params)
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. CALC(params[1]) .. '].isVisible = false end)'
end

M['showText'] = function(params)
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. CALC(params[1]) .. '].isVisible = true end)'
end

M['removeText'] = function(params)
    GAME.lua = GAME.lua .. '\n pcall(function() local name = ' .. CALC(params[1])
    GAME.lua = GAME.lua .. '\n GAME_texts[name]:removeSelf() GAME_texts[name] = nil end)'
end

M['frontText'] = function(params)
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. CALC(params[1]) .. ']:toFront() end)'
end

M['backText'] = function(params)
    GAME.lua = GAME.lua .. '\n pcall(function() GAME_texts[' .. CALC(params[1]) .. ']:toBack() end)'
end
...
M['saveValueNoob'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local data = GET_GAME_SAVE(CURRENT_LINK)'
    GAME.lua = GAME.lua .. '\n data[' .. key .. '] = ' .. value .. ' SET_GAME_SAVE(CURRENT_LINK, data) end)'
end
...
M['readValueNoob'] = function(params)
    ...
    GAME.lua = GAME.lua .. '\n pcall(function() local data = GET_GAME_SAVE(CURRENT_LINK) ' .. var
    GAME.lua = GAME.lua .. '\n = data[' .. key .. '] or ' .. var .. ' end)'
end
