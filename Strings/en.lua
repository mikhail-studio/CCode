return {
    ['lang.ru'] = 'Русский',
        ...
        ['button.copy'] = 'Copy',
        ['button.to.buffer'] = 'To buffer',
        ['button.from.buffer'] = 'From buffer',
        ['button.paste'] = 'Paste',
    ...
    ['blocks.create.var'] = 'Create variable',
        ...
        ['blocks.create.particle'] = 'Particles',
    ...
    ['blocks.events'] = 'Events',
        ...
        ['blocks.onCondition.params'] = {'Condition:'},
        ...
        ['blocks.onTouchDisplayBegan'] = 'When finger touches an screen',
        ['blocks.onTouchDisplayBegan.params'] = {'Table name:'},
        ['blocks.onTouchDisplayEnded'] = 'When finger releases the screen',
        ['blocks.onTouchDisplayEnded.params'] = {'Table name:'},
        ['blocks.onTouchDisplayMoved'] = 'When finger moves over an screen',
        ['blocks.onTouchDisplayMoved.params'] = {'Table name:'},
        ['blocks.onFirebase'] = 'Response received from Firebase',
        ['blocks.onFirebase.params'] = {'Function name:', 'Response:'},
        ...
        ['blocks.onLocalCollisionBegan'] = 'Beginning local collision',
            ['blocks.onLocalCollisionBegan.params'] = {'Function name:', 'Table name:'},
            ['blocks.onLocalCollisionEnded'] = 'End local collision',
            ['blocks.onLocalCollisionEnded.params'] = {'Function name:', 'Table name:'},
            ['blocks.onLocalPreCollision'] = 'Before local collision',
            ['blocks.onLocalPreCollision.params'] = {'Function name:', 'Table name:'},
            ['blocks.onLocalPostCollision'] = 'After local collision',
            ['blocks.onLocalPostCollision.params'] = {'Function name:', 'Table name:'},
            ['blocks.onGlobalCollisionBegan'] = 'Beginning global collision',
            ['blocks.onGlobalCollisionBegan.params'] = {'Function name:', 'Table name:'},
            ['blocks.onGlobalCollisionEnded'] = 'End global collision',
            ['blocks.onGlobalCollisionEnded.params'] = {'Function name:', 'Table name:'},
            ['blocks.onGlobalPreCollision'] = 'Before global collision',
            ['blocks.onGlobalPreCollision.params'] = {'Function name:', 'Table name:'},
            ['blocks.onGlobalPostCollision'] = 'After global collision',
            ['blocks.onGlobalPostCollision.params'] = {'Function name:', 'Table name:'},
            ['blocks.onWebViewCallback'] = 'There have been changes in webview',
            ['blocks.onWebViewCallback.params'] = {'Function name:', 'Table name:'},
            ['blocks.onSliderMoved'] = 'While slider is moving',
            ['blocks.onSliderMoved.params'] = {'Function name:', 'Variable name:'},
            ['blocks.onFieldBegan'] = 'Field editing has started',
            ['blocks.onFieldBegan.params'] = {'Function name:', 'Table name:'},
            ['blocks.onFieldEditing'] = 'While text field is being edited',
            ['blocks.onFieldEditing.params'] = {'Function name:', 'Table name:'},
            ['blocks.onFieldEnded'] = 'Field editing is finished',
            ['blocks.onFieldEnded.params'] = {'Function name:', 'Table name:'},
    ...
    ['blocks.vars'] = 'Data\n& Text',
        ...
        ['blocks.setObjVar.params'] = {'Key [K]:', 'Object name:', 'Value:'},
        ...
        ['blocks.insertTable.params'] = {'Key [N]:', 'Table name:', 'Value:'},
        ['blocks.removeTable'] = 'Delete value from array',
        ['blocks.removeTable.params'] = {'Table name:', 'Key [N]:'},
        ...
        ['blocks.setTextSize.params'] = {'Text name:', 'Size:'},
        ['blocks.hideText'] = 'Hide text',
        ['blocks.hideText.params'] = {'Text name:'},
        ['blocks.showText'] = 'Show text',
        ['blocks.showText.params'] = {'Text name:'},
        ['blocks.removeText'] = 'Remove text',
        ['blocks.removeText.params'] = {'Text name:'},
        ['blocks.setTextPos'] = 'Set text position',
            ...
            ['blocks.setTextColor.params'] = {'Text name:', 'Color:'},
            ['blocks.setTextRGB'] = 'Set RGB text color',
            ['blocks.setTextRGB.params'] = {'Text name:', 'Color (R):', 'Color (G):', 'Color (B):'},
            ['blocks.setTextHEX'] = 'Set HEX text color',
            ['blocks.setTextHEX.params'] = {'Text name:', 'Color (Hex):'},
            ['blocks.setTextAnchor'] = 'Set anchor point of text',
            ['blocks.setTextAnchor.params'] = {'Text name:', 'Anchor X (0-100):', 'Anchor Y (0-100):'},
            ...
            ['blocks.frontText.params'] = {'Text name:'},
    ...
    ['blocks.objects'] = 'Objects',
        ...
        ['blocks.setAnchor.params'] = {'Object name:', 'Anchor X (0-100):', 'Anchor Y (0-100):'},
        ...
        ['blocks.hideObject.params'] = {'Object name:'},
        ['blocks.showObject'] = 'Show object',
        ['blocks.showObject.params'] = {'Object name:'},
        ['blocks.removeObject'] = 'Remove object',
        ['blocks.removeObject.params'] = {'Object name:'},
        ['blocks.frontObject'] = 'Place object on layer above',
        ['blocks.frontObject.params'] = {'Object name:'},
        ['blocks.backObject'] = 'Place object on layer below',
        ['blocks.backObject.params'] = {'Object name:'},

    ['blocks.control'] = 'Control',
        ['blocks.timerEnd'] = 'End timer',
        ['blocks.timer'] = 'Timer',
        ['blocks.timer.params'] = {'Time (Seconds):', 'Number repetitions:'},
        ['blocks.timerNameEnd'] = 'End timer',
        ['blocks.timerName'] = 'Timer with name',
        ['blocks.timerName.params'] = {'Timer name:', 'Time (Seconds):', 'Number repetitions:'},
        ['blocks.timerPause'] = 'Pause timer',
        ['blocks.timerPause.params'] = {'Timer name:'},
        ['blocks.timerResume'] = 'Resume timer',
        ['blocks.timerResume.params'] = {'Timer name:'},
        ['blocks.timerCancel'] = 'Cancel timer',
        ['blocks.timerCancel.params'] = {'Timer name:'},
        ...
        ['blocks.whileEnd'] = 'End repeat',
        ['blocks.while'] = 'Repeat until condition is true',
        ['blocks.while.params'] = {'Condition:'},
        ['blocks.foreachEnd'] = 'End cycle',
        ['blocks.foreach'] = 'Bypass all table elements',
        ['blocks.foreach.params'] = {'Table name:', 'Variable name:'},
        ...
        ['blocks.setListener'] = 'Set touch function',
            ...
            ['blocks.setLocalCollision.params'] = {'Object name:', 'Function name:'},
            ['blocks.setLocalPreCollision'] = 'Set function before collision',
            ['blocks.setLocalPreCollision.params'] = {'Object name:', 'Function name:'},
            ['blocks.setLocalPostCollision'] = 'Set function after collision',
            ['blocks.setLocalPostCollision.params'] = {'Object name:', 'Function name:'},
            ['blocks.setGlobalCollision'] = 'Global collision function',
            ['blocks.setGlobalCollision.params'] = {'Function name:'},
            ['blocks.setGlobalPreCollision'] = 'Function before global collision',
            ['blocks.setGlobalPreCollision.params'] = {'Function name:'},
            ['blocks.setGlobalPostCollision'] = 'Function after global collision',
            ['blocks.setGlobalPostCollision.params'] = {'Function name:'},
            ...
            ['blocks.toastShort.params'] = {'Text:'},
            ['blocks.toastLong'] = 'Long pop-up notification',
            ['blocks.toastLong.params'] = {'Text:'},
    ...
    ['blocks.shapes'] = 'Textures\n& Shapes',
        ...
        ['blocks.newPolygon.params'] = {'Object name:', 'Angles table:', 'Position (X):', 'Position (Y):'},
        ['blocks.newLine'] = 'Create line',
        ['blocks.newLine.params'] = {'Object name:', 'Color:', 'Position1 (X):', 'Position1 (Y):', 'Position2 (X):', 'Position2 (Y):'},
        ['blocks.appendLine'] = 'Append point to line',
        ['blocks.appendLine.params'] = {'Object name:', 'Coordinate table:'},
        ...
        ['blocks.removePixel.params'] = {'Bitmap name:', 'Position (X):', 'Position (Y):'},
        ...
        ['blocks.setRGB.params'] = {'Object name:', 'Color (R):', 'Color (G):', 'Color (B):'},
        ['blocks.setHEX'] = 'Set HEX object color',
        ['blocks.setHEX.params'] = {'Object name:', 'Color (Hex):'},
    ...
    ['blocks.objects2'] = 'Animation\n& Masks',
        ...
        ['blocks.setFrame.params'] = {'Object name:', 'Frame:'},
    ...
    ['blocks.groups'] = 'Groups\n& Tags',
        ...
        ['blocks.addGroupMedia.params'] = {'Group name:', 'Media name:'},
        ...
        ['blocks.newTag'] = 'Create tag',
            ...
            ['blocks.addTagMedia.params'] = {'Tag name:', 'Media name:'},
    ...
    ['blocks.physics'] = 'Physics',
        ...
        ['blocks.setBody.params'] = {'Object name:', 'Type:', 'Density:', 'Bounce:', 'Friction:', 'Gravity:', 'Collision filter:', 'Collision table:'},
        ...
        ['blocks.setWorldGravity'] = 'Set world gravity',
            ...
            ['blocks.setBounce.params'] = {'Physical contact:', 'Bounce:'},
            ['blocks.setFriction'] = 'Set coefficient of friction',
            ['blocks.setFriction.params'] = {'Physical contact:', 'Friction:'},
            ['blocks.setTangentSpeed'] = 'Set tangential velocity',
            ['blocks.setTangentSpeed.params'] = {'Physical contact:', 'Velocity:'},
            ['blocks.disableCollision'] = 'Disable physical collision',
            ['blocks.disableCollision.params'] = {'Physical contact:'},
    ...
    ['blocks.widgets'] = 'Widgets',
        ...
        ['blocks.setWidgetListener.params'] = {'Widget name:', 'Function name:'},
    ...
    ['blocks.media'] = 'Media',
        ...
        ['blocks.newVideo.params'] = {'Media name:', 'Video name:', 'After execution:', 'Position (X):', 'Position (Y):', 'Width:', 'Height:'},
        ['blocks.newRemoteVideo'] = 'Create remote video',
        ['blocks.newRemoteVideo.params'] = {'Media name:', 'Url:', 'After execution:', 'Position (X):', 'Position (Y):', 'Width:', 'Height:'},
        ['blocks.loadSound'] = 'Load sound',
        ['blocks.loadSound.params'] = {'Media name:', 'Sound name:'},
        ['blocks.loadStream'] = 'Load streaming sound',
        ['blocks.loadStream.params'] = {'Media name:', 'Sound name:'},
        ['blocks.playSound'] = 'Play sound',
        ['blocks.playSound.params'] = {'Media name:', 'Number repetitions:', 'After execution:', 'Time (Seconds):', 'Fading (Seconds):'},
        ['blocks.resumeMedia'] = 'Resume media',
        ['blocks.resumeMedia.params'] = {'Media name:'},
        ['blocks.pauseMedia'] = 'Pause media',
        ['blocks.pauseMedia.params'] = {'Media name:'},
        ['blocks.seekMedia'] = 'Rewind media to timestamp',
        ['blocks.seekMedia.params'] = {'Media name:', 'Time (Seconds):'},
        ['blocks.setVolume'] = 'Set sound volume',
        ['blocks.setVolume.params'] = {'Media name:', 'Volume:'},
        ['blocks.fadeVolume'] = 'Fade sound volume',
        ['blocks.fadeVolume.params'] = {'Media name:', 'Time (Seconds):', 'Volume:'},
        ['blocks.stopSound'] = 'Stop sound',
        ['blocks.stopSound.params'] = {'Media name:'},
        ['blocks.stopTimerSound'] = 'Stop sound with timer',
        ['blocks.stopTimerSound.params'] = {'Media name:', 'Time (Seconds):'},
        ['blocks.disposeSound'] = 'Dispose sound',
        ['blocks.disposeSound.params'] = {'Media name:'},
        ['blocks.removeVideo'] = 'Remove video',
        ['blocks.removeVideo.params'] = {'Media name:'},

    ['blocks.snapshot'] = 'Snapshots\n& Captures',

    ['blocks.network'] = 'Network',
        ['blocks.openURL'] = 'Open url in browser',
        ['blocks.openURL.params'] = {'Url:'},
        ['blocks.createServer'] = 'Create LAN server',
        ['blocks.createServer.params'] = {'Port:', 'Server listener:'},
        ['blocks.connectToServer'] = 'Connect to LAN server',
        ['blocks.connectToServer.params'] = {'IP:', 'Port:', 'Client listener:'},
        ['blocks.requestGET'] = 'Asynchronous GET request',
        ['blocks.requestGET.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.requestPOST'] = 'Asynchronous POST request',
        ['blocks.requestPOST.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.requestPUT'] = 'Asynchronous PUT request',
        ['blocks.requestPUT.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.requestPATCH'] = 'Asynchronous PATCH request',
        ['blocks.requestPATCH.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.requestHEAD'] = 'Asynchronous HEAD request',
        ['blocks.requestHEAD.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.requestDELETE'] = 'Asynchronous DELETE request',
        ['blocks.requestDELETE.params'] = {'Url:', 'Request body:', 'Request header:', 'Request listener:', 'Type listener:', 'Redirection:', 'Timeout (Seconds):'},
        ['blocks.firebasePUT'] = 'Write to Firebase',
        ['blocks.firebasePUT.params'] = {'Token:', 'Value:', 'Key:', 'Request listener:'},
        ['blocks.firebasePATCH'] = 'Update in Firebase',
        ['blocks.firebasePATCH.params'] = {'Token:', 'Value:', 'Key:', 'Request listener:'},
        ['blocks.firebaseGET'] = 'Get from Firebase',
        ['blocks.firebaseGET.params'] = {'Token:', 'Key:', 'Request listener:'},
        ['blocks.firebaseDELETE'] = 'Remove from Firebase',
        ['blocks.firebaseDELETE.params'] = {'Token:', 'Key:', 'Request listener:'},

    ['blocks.transition'] = 'Transitions\n& Particles',
        ['blocks.setTransitionTo'] = 'Start transition',
        ['blocks.setTransitionTo.params'] = {'Name:', 'Type:', 'Animation type:', 'Number repetitions:', 'Time (Seconds):', 'Width:', 'Height:', 'Position (X):', 'Position (Y):', 'Scale (X):', 'Scale (Y):', 'Opacity (0-100):', 'Rotation (0-360):', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionPos'] = 'Set position transition',
        ['blocks.setTransitionPos.params'] = {'Name:', 'Type:', 'Animation type:', 'Number repetitions:', 'Time (Seconds):', 'Position (X):', 'Position (Y):', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionSize'] = 'Set size transition',
        ['blocks.setTransitionSize.params'] = {'Name:', 'Type:', 'Animation type:', 'Number repetitions:', 'Time (Seconds):', 'Width:', 'Height:', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionScale'] = 'Set scale transition',
        ['blocks.setTransitionScale.params'] = {'Name:', 'Type:', 'Animation type:', 'Number repetitions:', 'Time (Seconds):', 'Scale (X):', 'Scale (Y):', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionRotation'] = 'Set rotation transition',
        ['blocks.setTransitionRotation.params'] = {'Name:', 'Animation type:', 'Type:', 'Time (Seconds):', 'Number repetitions:', 'Rotation (0-360):', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionAlpha'] = 'Set alpha transition',
        ['blocks.setTransitionAlpha.params'] = {'Name:', 'Animation type:', 'Type:', 'Time (Seconds):', 'Number repetitions:', 'Opacity (0-100):', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionAngles'] = 'Set angles transition',
        ['blocks.setTransitionAngles.params'] = {'Name:', 'Animation type:', 'Type:', 'Time (Seconds):', 'Number repetitions:', 'Angles table:', 'Transition schedule:', 'After execution:', 'When paused:', 'After pause:', 'When stopping:', 'When repeating:'},
        ['blocks.setTransitionPause'] = 'Pause transition',
        ['blocks.setTransitionPause.params'] = {'Name:', 'Type:'},
        ['blocks.setTransitionResume'] = 'Resume transition',
        ['blocks.setTransitionResume.params'] = {'Name:', 'Type:'},
        ['blocks.setTransitionCancel'] = 'Cancel transition',
        ['blocks.setTransitionCancel.params'] = {'Name:', 'Type:'},
